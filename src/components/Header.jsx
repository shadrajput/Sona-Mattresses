...
export function Header(props) {
  ...
  return (
    <header className=" lg:z-20 2xl:px-24">
      <nav className="relative z-50 text-sm">
        <div className="flex flex-col md:flex-row items-center  py-2 sm:py-3  ">
          <div className='flex items-center justify-between w-full md:w-32'>
            <div>
              <Link href="/">
                <div className='w-24 sm:w-32 lg:w-48 cursor-pointer'>
          ...
          <div className={` ${menu ? "top-16 opacity-100 sm:top-[80px]" : "top-[-500px] opacity-0 md:opacity-100"} bg-black md:bg-white 
