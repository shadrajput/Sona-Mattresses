              ...
              {index == currentIndex && (
                <div className="absolute top-32 left-3 xs:top-28 sm:top-40 sm:left-10 md:top-48 lg:top-60 lg:left-16 2xl:top-72 2xl:left-40 2xl:w-[800px]">
                  ...
                  <motion.h1
                    ...
                    className="pt-3 font-bold text-black xs:text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-[55px]"
                  >
                    {item.heading2}
                  </motion.h1>
                  <motion.p
                  ...
                  <motion.button
                    ...
                    className="btn1 group z-50 my-2 border border-black py-1 text-[12px] text-sm font-semibold hover:text-white sm:py-2 xl:py-3 "
                  >
                    Shop Now
