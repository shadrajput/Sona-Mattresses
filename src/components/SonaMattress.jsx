...
export default function SonaMattress() {
    return (
        <div className='flex flex-col justify-center items-center md:items-start px-10 py-5 xl:px-36 2xl:py-20'>
            <div className='grid md:grid-cols-2'>
                <div className="order-2 md:order-1 md:mt-10">
                    <motion.h1
                        ...
                        className="text-3xl lg:text-4xl font-bold text-[#b19777]">Comfort mattress</motion.h1>
                    <motion.h1
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 0 }}
                        transition={{ duration: .5 , delay : .5 }}
                        className="text-black text-3xl lg:text-4xl font-bold">for your healthy sleep</motion.h1>
            ...
            <div className='grid grid-rows-3 justify-center items-center w-full sm:grid-cols-3 sm:grid-rows-1 pb-5 2xl:hidden'>
