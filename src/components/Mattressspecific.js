...
import image from "../../public/images/mattress.jpg"
    ...
    return (
        <div className="h-full w-full relative">
            ...
            <div className="absolute top-[30%] left-[10%] w-[550px]">
                <p className="text-3xl font-bold">Special mattress padding can hold up  <span className="text-[#ae9775]"> to 20% moisture</span>,that providing comfort sleep also for children</p>
