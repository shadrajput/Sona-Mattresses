    ...
    return (
        <div className="h-full w-full relative">
            ...
            <div className="absolute top-5 2xl:top-[30%] xl:left-[10%] xl:w-[550px] left-7 right-24 sm:right-52 md:right-60 md:top-10 lg:left-16 lg:top-24">
                <p className=" text-sm sm:text-2xl lg:text-3xl font-bold lg:pr-20">Special mattress padding can hold up  <span className="text-[#b19777]"> to 20% moisture</span>,that providing comfort sleep also for children</p>
