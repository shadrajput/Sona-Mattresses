                ...
                <div>
                    ...
                    <div className='grid grid-cols-3 '>
                        <div className='flex flex-col justify-center items-start'>
                            <Image src={maticon1} alt="fess manager logo" className='w-full h-full' />
                            <h1 className='font-bold pt-6 text-lg ml-6'>
                                No springs
                            </h1>
                        </div>
                        <div className='flex flex-col justify-center items-start'>
                            <Image src={maticon2} alt="fess manager logo" className='w-full h-full relative' />
                            <h1 className='font-bold pt-6 text-lg ml-6'>
                                High quality latex
                            </h1>
                        </div>
                        <div className='flex flex-col justify-center items-start'>
                            <Image src={maticon3} alt="fess manager logo" className='w-full h-full relative' />
                            <h1 className='font-bold pt-6 text-lg ml-6'>
                                Glueless technology
                            </h1>
                        </div>
